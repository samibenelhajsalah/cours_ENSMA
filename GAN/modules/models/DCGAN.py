# ------------------------------------------------------------------
#     Sami BEN ELHAJ SALAH          DCGAN Example
# ------------------------------------------------------------------
# Deep Learning
# ------------------------------------------------------------------
# by Sami BEN ELHAJ SALAH (Jan 2024), example
#
...
class DCGAN(keras.Model):
    ...
    def __init__(self, discriminator=None, generator=None, latent_dim=128, **kwargs):
        '''
        ...
        print(f' DCGAN is ready:-)  latent dim = {latent_dim}')
...
#         labels += 0.05 * tf.random.uniform(tf.shape(labels))
    ...
    def about(cls):
        '''Basic whoami method'''
        display(Markdown('<br>**2024 - DCGAN**'))
